...
public class DesvioEncadeado {
    ...
    public static void main(String[] args) {
        ...
        if(idade < 16) {
            System.out.println("Desculpe, você não tem idade suficiente para votar nem embarcar");
        }else  {
            if (idade >= 18) {
                System.out.println("É obrigatório votar, pode embarcar");
            }else {
                System.out.println("Você pode você pode embarcar");
            }
        }
